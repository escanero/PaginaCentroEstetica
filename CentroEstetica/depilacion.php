...
// Verifica si se ha enviado un producto a través del parámetro en la URL
...
<head>
    ...
    <title>Depilación-Centros Ideal</title>
...
<body>
    ...
    <div class="grid">
        <div class="item"><a href="Depilacion.php?producto=depilacion para ellas"><img src="CSS/depilacion_ellas.jpg"></a></div>
        <div class="item"><a href="Depilacion.php?producto=depilacion para ellos"><img src="CSS/depilacion_ellos.jpg"></a></div>
        <div class="item"><a href="#"><img src="CSS/maquina.jpg"></a></div>
        <div class="item"><a href="#"><img src="CSS/precios.jpg"></a></div>
    </div>
