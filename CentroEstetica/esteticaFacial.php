...
<head>
    ...
    <title>Estética Facial-Centros Ideal</title>
...
<body>
    ...
    <div class="gridF">
        <div class="item">
            <a href="#" onclick="agregarAlCarrito('Dermopen Deluxe', 30)">
                <img src="CSS/Dermopen_deluxe.jpg">
                <span>30€</span>
            </a>
        </div>
        <div class="item">
            <a href="#" onclick="agregarAlCarrito('Hidro Limpieza' ,50)">
                <img src="CSS/Hydro_limpieza.jpg">
                <span>50€</span>
            </a>
        </div>

        <div class="item">
            <a href="#" onclick="agregarAlCarrito('Antiedad', 40)">
                <img src="CSS/antiedad.jpg">
                <span>40€</span>
            </a>
        </div>

        <div class="item">
            <a href="#" onclick="agregarAlCarrito('Iluminador Milena', 25)">
                <img src="CSS/Iluminadore_Milena.jpg">
                <span>25€</span>
            </a>
        </div>

        <div class="item">
            <a href="#" onclick="agregarAlCarrito('Cyclone Facial', 100)">
                <img src="CSS/Cyclone_facial.jpg">
                <span>100€</span>
            </a>
        </div>

        <div class="item">
            <a href="#" onclick="agregarAlCarrito('Cosmetología Facial', 80)">
                <img src="CSS/Cosmetología_facial.jpg">
                <span>80€</span>
            </a>
        </div>
    ...
    function agregarAlCarrito(producto, precio) {
        // Realiza una petición AJAX para agregar el producto y precio al carrito.php
        var xhr = new XMLHttpRequest();
        xhr.onreadystatechange = function() {
            if (xhr.readyState === 4 && xhr.status === 200) {
                // Actualiza el elemento HTML con el mensaje
                document.getElementById('mensajeCarrito').innerText = "Producto " + producto + " agregado al carrito correctamente.";
            }
        };
        xhr.open("GET", "carrito.php?producto=" + encodeURIComponent(producto) + "&precio=" + encodeURIComponent(precio), true);
        xhr.send();
    }
</script>
