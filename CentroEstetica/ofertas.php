...
<head>
    ...
    <link rel="stylesheet" href="../Vaguada/CSS/style.css">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@48,400,0,0" />
    <title>Ofertas-Centros Ideal</title>
...
<body>
    ...
    <div class="sOfertas">
        <div class="TituloOferta">
            <H2> Ofertas en depilación láser, tratamientos corporales y tratamientos faciales.</H2>
        </div>

        <div class="gridOfer">
            <div class="itemOfer"><a href="#"><img src="../Vaguada/CSS/depilacionHOferta.jpg"></a></div>
            <div class="itemOfer"><a href="#"><img src="../Vaguada/CSS/depilacionMTienda.jpg"></a></div>
            <div class="itemOfer"><a href="#"><img src="../Vaguada/CSS/slider2.jpg"></a></div>
            <div class="itemOfer"><a href="#"><img src="../Vaguada/CSS/rebajas.jpg"></a></div>
        </div>

        <video class="video2" src="CSS/Video Centros Ideal.mp4" autoplay="true" muted="true" loop="true"></video>
    </div>
