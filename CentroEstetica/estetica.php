...
<head>
    ...
    <title>Estética-Centros Ideal</title>
...
<body>
    ...
    <div class="grid">
        <div class="item"><a href="esteticaFacial.php"><img src="CSS/facial.jpg"></a>

        </div>
        <div class="item"><a href="esteticaCorporal.php"><img src="CSS/corporal.jpg"></a>

        </div>
    </div>
    <div class="container-portada3">
        <div class="capa-gradient3"></div>
        <div class="container-details3">
