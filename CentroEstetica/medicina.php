...
<head>
    ...
    <title>Medicina Estética-Centros Ideal</title>
...
<body>
    ...
    <div class="grid">
        <div class="item"><a href="medicinaFacil.php"><img src="CSS/facial.jpg"></a>

        </div>
        <div class="item"><a href="medicinaCorporal.php"><img src="CSS/corporal.jpg"></a>
